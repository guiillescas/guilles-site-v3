            ...
            <div className="relative">
              ...
              <div className="space-y-12 md:space-y-20">
                <ExperienceCard
                  ...
                  company="AwSales · Tempo integral"
                ...
                <ExperienceCard
                  id="previdenciarista"
                  title="Senior Software Engineer"
                  company="Previdenciarista · Terceirizado"
                  date="Nov 2023 - Set 2025"
                ...
                <ExperienceCard
                  id="conquer"
                  title="Senior Software Engineer"
                  company="Escola Conquer · Tempo integral"
                ...
                <ExperienceCard
                  ...
                  company="Amank · Autônomo"
                  date="Ago 2022 - Mai 2023"
                  duration="10 meses"
                  color="rose"
                  position="right"
                  description={
